...
const Sp = () => {
  return (
    <div className='w-full h-[500px] bg-black'>
      <div className='h-96'>
      <h1 className='text-white text-center text-6xl p-6'>Why Us?</h1>
      <div className='flex flex-col md:flex-row space-x-10 p-10 w-full h-full'>
        {/* First Box */}
        <div className='border-2 border-purple-500 w-full h-full md:h-auto rounded-md shadow-md shadow-purple-500 flex-grow flex flex-col items-center justify-center p-6'>
